...
replace (
	...
	github.com/vmware-tanzu/tanzu-framework/apis/discovery => ../../apis/discovery
...
require (
	...
	github.com/vmware-tanzu/tanzu-framework/apis/discovery v0.0.0-00010101000000-000000000000
