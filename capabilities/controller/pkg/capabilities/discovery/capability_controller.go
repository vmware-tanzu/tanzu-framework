...
import (
	...
	discoveryv1alpha1 "github.com/vmware-tanzu/tanzu-framework/apis/discovery/v1alpha1"
...
func (r *CapabilityReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	capability := &discoveryv1alpha1.Capability{}
	...
	capability.Status.Results = make([]discoveryv1alpha1.Result, len(capability.Spec.Queries))
...
func (r *CapabilityReconciler) queryGVRs(log logr.Logger, clusterQueryClient *discovery.ClusterQueryClient, queries []discoveryv1alpha1.QueryGVR) []discoveryv1alpha1.QueryResult {
...
func (r *CapabilityReconciler) queryObjects(log logr.Logger, clusterQueryClient *discovery.ClusterQueryClient, queries []discoveryv1alpha1.QueryObject) []discoveryv1alpha1.QueryResult {
...
func (r *CapabilityReconciler) queryPartialSchemas(log logr.Logger, clusterQueryClient *discovery.ClusterQueryClient, queries []discoveryv1alpha1.QueryPartialSchema) []discoveryv1alpha1.QueryResult {
...
func (r *CapabilityReconciler) executeQueries(log logr.Logger, clusterQueryClient *discovery.ClusterQueryClient, specToQueryTargetFn func() map[string]discovery.QueryTarget) []discoveryv1alpha1.QueryResult {
	var results []discoveryv1alpha1.QueryResult
	queryTargetsMap := specToQueryTargetFn()
	for name, queryTarget := range queryTargetsMap {
		result := discoveryv1alpha1.QueryResult{Name: name}
...
func (r *CapabilityReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&discoveryv1alpha1.Capability{}).
		Complete(r)
}
