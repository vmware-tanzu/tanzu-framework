...
// Package discovery implements the functionality for capabilities discovery
// TODO: pkalle this package can be replaced by importing the capabilities module.
package discovery
