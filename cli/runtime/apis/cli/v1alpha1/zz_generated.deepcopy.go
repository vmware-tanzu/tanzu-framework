...
func (in *Catalog) DeepCopyInto(out *Catalog) {
	*out = *in
	...
	if in.StandAlonePluginsByContextType != nil {
		in, out := &in.StandAlonePluginsByContextType, &out.StandAlonePluginsByContextType
		*out = make(map[configv1alpha1.ContextType]PluginAssociation, len(*in))
		for key, val := range *in {
