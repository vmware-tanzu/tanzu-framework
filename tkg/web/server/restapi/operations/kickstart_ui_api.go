...
func NewKickstartUIAPI(spec *loads.Document) *KickstartUIAPI {
	return &KickstartUIAPI{
		...
		UIGetUIHandler: ui.GetUIHandlerFunc(func(params ui.GetUIParams) middleware.Responder {
			return middleware.NotImplemented("operation UIGetUI has not yet been implemented")
		}),
		UIGetUIFileHandler: ui.GetUIFileHandlerFunc(func(params ui.GetUIFileParams) middleware.Responder {
			return middleware.NotImplemented("operation UIGetUIFile has not yet been implemented")
		}),
...
func (o *KickstartUIAPI) Validate() error {
	...
	if o.UIGetUIHandler == nil {
		unregistered = append(unregistered, "ui.GetUIHandler")
	}

	if o.UIGetUIFileHandler == nil {
		unregistered = append(unregistered, "ui.GetUIFileHandler")
	}
...
func (o *KickstartUIAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/api/providers/aws/keypair"] = aws.NewGetAWSKeyPairs(o.context, o.AwsGetAWSKeyPairsHandler)
	...
	o.handlers["GET"][""] = ui.NewGetUI(o.context, o.UIGetUIHandler)

	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/{filename}"] = ui.NewGetUIFile(o.context, o.UIGetUIFileHandler)
