...
func init() {
  ...
  "swagger": "2.0",
  "info": {
    "description": "Tanzu Kubernetes Grid Setup API.",
    "title": "Tanzu Kubernetes Grid Setup API",
    "version": "0.0.0"
  },
  "basePath": "/",
  "paths": {
    ...
    "/{filename}": {
      "get": {
        ...
        "summary": "Get the kickstart UI static resource file",
        "operationId": "getUIFile",
        "parameters": [
          {
            "type": "string",
            "description": "UI file name",
            "name": "filename",
            "in": "path",
            "required": true
          }
