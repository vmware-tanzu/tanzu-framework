...
type KappClient struct {
	...
	createPackageInstallArgsForCall []struct {
		...
		arg2 *packagedatamodel.PkgPluginResourceCreationStatus
	}
...
func (fake *KappClient) CreatePackageInstall(arg1 *v1alpha1.PackageInstall, arg2 *packagedatamodel.PkgPluginResourceCreationStatus) error {
...
func (fake *KappClient) UpdatePackageInstall(arg1 *v1alpha1.PackageInstall, arg2 *packagedatamodel.PkgPluginResourceCreationStatus) error {
