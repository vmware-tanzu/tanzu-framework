...
func (p *pkgClient) UpdateRegistrySecret(o *packagedatamodel.RegistrySecretOptions) error {
...
func extractExistingSecretCredentials(secret *corev1.Secret, o *packagedatamodel.RegistrySecretOptions) (string, string, string, error) {
	var (
		registry string
		username string
		password string
...
func (p *pkgClient) UpdateSecretExport(o *packagedatamodel.RegistrySecretOptions) error {
