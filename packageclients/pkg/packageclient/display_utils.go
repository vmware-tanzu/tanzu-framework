...
func DisplayProgress(initialMsg string, pp *packagedatamodel.PackageProgress) error { //nolint:gocyclo
	var (
		currMsg string
		s       *spinner.Spinner
		err     error
...
func newPackageProgress() *packagedatamodel.PackageProgress {
	return &packagedatamodel.PackageProgress{
