...
replace (
	...
	sigs.k8s.io/cluster-api/test => sigs.k8s.io/cluster-api/test v1.1.5
)
...
require (
	...
	github.com/vmware-tanzu/carvel-kapp-controller/cli v0.0.0-20220411140813-76cc59c7a26a
	github.com/vmware-tanzu/tanzu-framework v0.27.0-dev.0.20220909183728-d04b7ebf004c
...
require (
	...
	github.com/vmware-tanzu/tanzu-framework/tkg v0.0.0-00010101000000-000000000000 // indirect
