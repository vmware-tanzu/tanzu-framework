...
require (
	...
	k8s.io/apiserver v0.25.1-rc.0 // indirect
	k8s.io/cluster-bootstrap v0.25.0 // indirect
	k8s.io/component-base v0.25.1-rc.0 // indirect
	k8s.io/klog/v2 v2.80.1 // indirect
	k8s.io/kube-openapi v0.0.0-20221207184640-f3cff1453715 // indirect
	k8s.io/kubectl v0.25.0 // indirect
	k8s.io/utils v0.0.0-20220823124924-e9cbc92d1a73 // indirect
	sigs.k8s.io/cluster-api v1.3.3 // indirect
	sigs.k8s.io/cluster-api-provider-aws/v2 v2.0.2 // indirect
	sigs.k8s.io/cluster-api-provider-azure v1.7.2 // indirect
	sigs.k8s.io/cluster-api-provider-vsphere v1.4.1 // indirect
	sigs.k8s.io/cluster-api/test v1.3.3 // indirect
