...
func initialize() error {
	...
	featureGenerationCommand := fmt.Sprintf("codegen generate paths=./cmd/cli/plugin-admin/codegen/test/testData/... feature output:feature:artifacts:config=%s", tempDir)
