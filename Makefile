...
manifests: ## Generate manifests e.g. CRD, RBAC etc.
	$(MAKE) -C apis/addonconfigs generate-manifests CONTROLLER_GEN_SRC=./...
	$(MAKE) -C apis/cli generate-manifests CONTROLLER_GEN_SRC=./...
	$(MAKE) -C apis/config generate-manifests CONTROLLER_GEN_SRC=./...
	$(MAKE) -C apis/core generate-manifests CONTROLLER_GEN_SRC=./...
	$(MAKE) -C apis/run generate-manifests CONTROLLER_GEN_SRC=./...
	$(MAKE) -C cli/runtime generate-manifests CONTROLLER_GEN_SRC=./...
