...
generate-package-config:
	@cd addons/config/templates && \
		$(YTT) --ignore-unknown-comments -f ${apiGroup}/${version}/$(shell echo $(kind) | tr A-Z a-z).yaml -v TKR_VERSION=${tkr} -v GLOBAL_NAMESPACE=$(or $(namespace),"tkg-system") ;\
