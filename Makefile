...
configure-plugin-runtime-version: ## Configure plugin runtime version
	...
	sed "s+TANZU_PLUGIN_RUNTIME_VERSION+${BUILD_VERSION}+g"  hack/update-bundled-plugin-runtime-version/update-bundled-plugin-runtime-version.txt  > pkg/v1/cli/version/zz_generated_plugin_runtime_version.go
