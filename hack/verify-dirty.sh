...
# pkg/v1/cli/version/zz_generated_plugin_runtime_version.go. This is to support `usebom` directive
# in tests.
ignore_files=(':(exclude)tkg/tkgconfigpaths/zz_bundled_default_bom_files_configdata.go' ':(exclude)pkg/v1/cli/version/zz_generated_plugin_runtime_version.go')
