...
func (in *ContextStatus) DeepCopyInto(out *ContextStatus) {
	*out = *in
	in.GlobalAuth.DeepCopyInto(&out.GlobalAuth)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GlobalAuthConfig) DeepCopyInto(out *GlobalAuthConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GlobalAuthConfig.
func (in *GlobalAuthConfig) DeepCopy() *GlobalAuthConfig {
	if in == nil {
		return nil
	}
	out := new(GlobalAuthConfig)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GlobalAuthStatus) DeepCopyInto(out *GlobalAuthStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GlobalAuthStatus.
func (in *GlobalAuthStatus) DeepCopy() *GlobalAuthStatus {
	if in == nil {
		return nil
	}
	out := new(GlobalAuthStatus)
	in.DeepCopyInto(out)
	return out
}
