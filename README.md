...
```
cd existing_repo
git remote add origin https://gitlab.eng.vmware.com/tanzu-framework/tkg.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.eng.vmware.com/tanzu-framework/tkg/-/settings/integrations)
