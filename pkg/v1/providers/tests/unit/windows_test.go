...
var _ = Describe("Windows Ytt Templating", func() {
	...
	BeforeEach(func() {
		paths = []string{
			...
			filepath.Join(yamlRoot, "infrastructure-vsphere", "v0.7.10", "ytt", "base-template.yaml"),
			filepath.Join(yamlRoot, "infrastructure-vsphere", "v0.7.10", "ytt", "overlay-windows.yaml"),
