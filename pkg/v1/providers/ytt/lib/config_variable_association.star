...
"CONTROL_PLANE_MACHINE_COUNT": ["vsphere", "aws", "azure", "tkg-service-vsphere", "docker", "byoh"],
"WORKER_MACHINE_COUNT": ["vsphere", "aws", "azure", "tkg-service-vsphere", "docker", "byoh"],
...
"ANTREA_NO_SNAT": ["vsphere", "aws", "azure", "docker", "byoh"],
"ANTREA_TRAFFIC_ENCAP_MODE": ["vsphere", "aws", "azure", "docker", "byoh"],
"ANTREA_PROXY": ["vsphere", "aws", "azure", "docker", "byoh"],
"ANTREA_ENDPOINTSLICE": ["vsphere", "aws", "azure", "docker", "byoh"],
"ANTREA_POLICY": ["vsphere", "aws", "azure", "docker", "byoh"],
"ANTREA_NODEPORTLOCAL": ["vsphere", "aws", "azure", "docker", "byoh"],
"ANTREA_TRACEFLOW": ["vsphere", "aws", "azure", "docker", "byoh"],

"PROVIDER_TYPE": ["vsphere", "aws", "azure", "tkg-service-vsphere", "docker", "byoh"],
"TKG_CLUSTER_ROLE": ["vsphere", "aws", "azure", "tkg-service-vsphere", "docker", "byoh"],
"TKG_VERSION": ["vsphere", "aws", "azure", "tkg-service-vsphere", "docker", "byoh"],
"CNI": ["vsphere", "aws", "azure", "docker", "byoh"],
