...
export const AwsNodeSettingStepMapping: StepMapping = {
    fieldMappings: [
        ...
        { name: AwsField.NODESETTING_INSTANCE_TYPE_DEV, required: true, label: 'DEVELOPMENT INSTANCE TYPE', requiresBackendData: true },
        { name: AwsField.NODESETTING_INSTANCE_TYPE_PROD, required: true, label: 'PRODUCTION INSTANCE TYPE', requiresBackendData: true },
        { name: AwsField.NODESETTING_MACHINE_HEALTH_CHECKS_ENABLED, isBoolean: true, defaultValue: true,
            label: 'ENABLE MACHINE HEALTH CHECKS' },
        { name: AwsField.NODESETTING_ENABLE_AUDIT_LOGGING, isBoolean: true, label: 'ENABLE AUDIT LOGGING' },
        ...
        { name: AwsField.NODESETTING_WORKERTYPE_1, label: 'AZ1 WORKER NODE INSTANCE TYPE', requiresBackendData: true },
