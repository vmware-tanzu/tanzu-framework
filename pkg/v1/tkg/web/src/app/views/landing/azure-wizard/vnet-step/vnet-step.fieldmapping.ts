...
export const AzureVnetStandaloneStepMapping: StepMapping = {
    fieldMappings: [
        ...
        { name: AzureField.VNET_CONTROLPLANE_NEWSUBNET_NAME, required: true, doNotAutoRestore: true },
        { name: AzureField.VNET_CONTROLPLANE_SUBNET_NAME, required: true, requiresBackendData: true },
        { name: AzureField.VNET_CUSTOM_NAME, required: true, doNotAutoRestore: true },
        { name: AzureField.VNET_EXISTING_NAME, required: true, requiresBackendData: true },
        { name: AzureField.VNET_EXISTING_OR_CUSTOM, required: true, primaryTrigger: true },
        { name: AzureField.VNET_PRIVATE_CLUSTER, isBoolean: true },
        { name: AzureField.VNET_PRIVATE_IP },
        { name: AzureField.VNET_RESOURCE_GROUP, required: true, requiresBackendData: true },
        ...
        // defaultCidrFields
        { name: AzureField.VNET_CUSTOM_CIDR, required: true, doNotAutoRestore: true,
...
export const AzureVnetStepMapping: StepMapping = {
    fieldMappings: [
        ...
        { name: AzureField.VNET_WORKER_NEWSUBNET_NAME, required: true, doNotAutoRestore: true },
        { name: AzureField.VNET_WORKER_NEWSUBNET_CIDR, required: true, doNotAutoRestore: true },
        { name: AzureField.VNET_WORKER_SUBNET_NAME, required: true, requiresBackendData: true },
        // defaultCidrFields
        { name: AzureField.VNET_WORKER_NEWSUBNET_CIDR, required: true, doNotAutoRestore: true,
            validators: [SimpleValidator.NO_WHITE_SPACE, SimpleValidator.IS_VALID_IP_NETWORK_SEGMENT] },
    ]
