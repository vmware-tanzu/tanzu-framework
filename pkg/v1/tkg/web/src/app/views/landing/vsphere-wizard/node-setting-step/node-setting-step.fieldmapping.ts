...
export const VsphereNodeSettingStandaloneFieldMapping: StepMapping = {
    fieldMappings: [
...
export const VsphereNodeSettingFieldMapping: StepMapping = {
    fieldMappings: [
        ...VsphereNodeSettingStandaloneFieldMapping.fieldMappings,
