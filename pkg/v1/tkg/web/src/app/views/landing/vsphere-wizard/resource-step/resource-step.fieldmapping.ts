...
export const VsphereResourceStepMapping: StepMapping = {
    fieldMappings: [
        { name: VsphereField.RESOURCE_POOL, required: true, requiresBackendData: true },
        { name: VsphereField.RESOURCE_DATASTORE, required: true, requiresBackendData: true },
        { name: VsphereField.RESOURCE_VMFOLDER, required: true, requiresBackendData: true },
    ]
}
