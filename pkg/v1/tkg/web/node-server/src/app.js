...
app.use(
    rateLimit({
        ...
        max: 6,
        message: "You exceeded 6 requests per second",
        headers: true
    })
);
...
// local API routes are used, and they load the mock services
winston.info('using API mock services');
let mockServiceRoute = require(paths.src.mockServiceRoute);
app.use(mockServiceRoute);
