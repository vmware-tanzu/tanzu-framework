...
func (o *GenerateTKGConfigForVsphereURL) Build() (*url.URL, error) {
	...
	var _path = "/api/providers/vsphere/generate"
...
func (o *GenerateTKGConfigForVsphereURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GenerateTKGConfigForVsphereURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GenerateTKGConfigForVsphereURL")
	}
