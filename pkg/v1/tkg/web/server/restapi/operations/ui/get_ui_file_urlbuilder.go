...
func (o *GetUIFileURL) Build() (*url.URL, error) {
	...
	if filename != "" {
		...
		return nil, errors.New("filename is required on GetUIFileURL")
	}
...
func (o *GetUIFileURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetUIFileURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetUIFileURL")
	}
