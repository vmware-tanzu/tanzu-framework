...
func (o *GenerateTKGConfigForDockerURL) Build() (*url.URL, error) {
	...
	var _path = "/api/providers/docker/generate"
...
func (o *GenerateTKGConfigForDockerURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GenerateTKGConfigForDockerURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GenerateTKGConfigForDockerURL")
	}
