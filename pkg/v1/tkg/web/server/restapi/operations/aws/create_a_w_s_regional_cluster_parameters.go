...
// CreateAWSRegionalClusterParams contains all the bound params for the create a w s regional cluster operation
...
func (o *CreateAWSRegionalClusterParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
