...
// ExportTKGConfigForAWSParams contains all the bound params for the export t k g config for a w s operation
...
func (o *ExportTKGConfigForAWSParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
