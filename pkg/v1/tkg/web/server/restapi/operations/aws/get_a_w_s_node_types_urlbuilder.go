...
func (o *GetAWSNodeTypesURL) Build() (*url.URL, error) {
	...
	var _path = "/api/providers/aws/nodetypes"
...
func (o *GetAWSNodeTypesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAWSNodeTypesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAWSNodeTypesURL")
	}
