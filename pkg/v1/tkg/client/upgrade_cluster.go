...
func isNewDockerTemplateRequired(machineTemplate *capdv1alpha4.DockerMachineTemplate, clusterUpgradeConfig *clusterUpgradeInfo, actualK8sVersion *string) bool {
	if actualK8sVersion == nil || *actualK8sVersion != clusterUpgradeConfig.UpgradeComponentInfo.KubernetesVersion {
		return true
	}
...
func (c *TkgClient) createAWSControlPlaneMachineTemplate(regionalClusterClient clusterclient.Client, kcp *capikubeadmv1alpha4.KubeadmControlPlane, clusterUpgradeConfig *clusterUpgradeInfo) error {
	var err error
...
func (c *TkgClient) createCAPDInfrastructureTemplateForUpgrade(regionalClusterClient clusterclient.Client, kcp *capikubeadmv1alpha4.KubeadmControlPlane, clusterUpgradeConfig *clusterUpgradeInfo) error {
...
func (c *TkgClient) createAWSInfrastructureTemplateForUpgrade(regionalClusterClient clusterclient.Client, kcp *capikubeadmv1alpha4.KubeadmControlPlane, clusterUpgradeConfig *clusterUpgradeInfo) error {
...
func (c *TkgClient) createCAPDControlPlaneMachineTemplate(regionalClusterClient clusterclient.Client, kcp *capikubeadmv1alpha4.KubeadmControlPlane, clusterUpgradeConfig *clusterUpgradeInfo) error {
	var err error
	dockerMachineTemplate := &capdv1alpha4.DockerMachineTemplate{}
	...
	dockerMachineTemplateForUpgrade := &capdv1alpha4.DockerMachineTemplate{}
...
func (c *TkgClient) createCAPDMachineDeploymentMachineTemplateForWorkers(regionalClusterClient clusterclient.Client, clusterUpgradeConfig *clusterUpgradeInfo) error {
	var err error
	for i := range clusterUpgradeConfig.MDObjects {
		dockerMachineTemplateForMD := &capdv1alpha4.DockerMachineTemplate{}
		...
		dockerMachineTemplateMDForUpgrade := &capdv1alpha4.DockerMachineTemplate{}
...
func (c *TkgClient) createAzureInfrastructureTemplateForUpgrade(regionalClusterClient clusterclient.Client, kcp *capikubeadmv1alpha4.KubeadmControlPlane, clusterUpgradeConfig *clusterUpgradeInfo) error {
...
func (c *TkgClient) createVsphereInfrastructureTemplateForUpgrade(regionalClusterClient clusterclient.Client, kcp *capikubeadmv1alpha4.KubeadmControlPlane, clusterUpgradeConfig *clusterUpgradeInfo) error {
	var err error
...
func (c *TkgClient) patchKubernetesVersionToKubeadmControlPlane(regionalClusterClient clusterclient.Client, clusterUpgradeConfig *clusterUpgradeInfo) error {
	...
	pollOptions := &clusterclient.PollOptions{Interval: upgradePatchInterval, Timeout: upgradePatchTimeout}
	err := regionalClusterClient.PatchResource(&capikubeadmv1alpha4.KubeadmControlPlane{}, clusterUpgradeConfig.KCPObjectName, clusterUpgradeConfig.KCPObjectNamespace, patchKubernetesVersion, types.MergePatchType, pollOptions)
	if err != nil {
