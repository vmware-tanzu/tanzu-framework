...
// ConfigureAndValidateBYOHConfig configures and validates docker configuration
func (c *TkgClient) ConfigureAndValidateBYOHConfig(tkrVersion string, nodeSizes NodeSizeOptions, skipValidation bool) error {
	c.SetProviderType(BYOHProviderName)
	// TODO: May update some validation logic in future
	if tkrVersion == "" {
		return errors.New("TKr version is empty")
	}
