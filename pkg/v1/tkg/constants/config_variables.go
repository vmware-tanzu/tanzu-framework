...
const (
	...
	ConfigVariableAutoscalerMaxNodesTotal             = "AUTOSCALER_MAX_NODES_TOTAL"
	ConfigVariableScaleDownDelayAfterAdd              = "AUTOSCALER_SCALE_DOWN_DELAY_AFTER_ADD"
	ConfigVariableAutoScalerScaleDownDelayAfterDelete = "AUTOSCALER_SCALE_DOWN_DELAY_AFTER_DELETE"
	ConfigVariableScaleDownDelayAfterFailure          = "AUTOSCALER_SCALE_DOWN_DELAY_AFTER_FAILURE"
	ConfigVariableScaleDownUnneededTime               = "AUTOSCALER_SCALE_DOWN_UNNEEDED_TIME"
	ConfigVariableMaxNodeProvisionTime                = "AUTOSCALER_MAX_NODE_PROVISION_TIME"
