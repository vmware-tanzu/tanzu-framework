...
var CclusterToLegacyVariablesMapCommon = map[string]string{
...
// CclusterVariablesWithHigherPrecedence holds cluster class input attributes which overrides attributes (value's in this map) already has value (may be)
var CclusterVariablesWithHigherPrecedence = map[string]string{
...
var CclusterToLegacyVariablesMapAws = map[string]string{
...
var CclusterToLegacyVariablesMapAzure = map[string]string{
...
var CclusterToLegacyVariablesMapVsphere = map[string]string{
...
var CclusterToLegacyVariablesMapDocker = map[string]string{}
...
var InfrastructureSpecificVariableMappingMap = map[string]map[string]string{
	InfrastructureProviderVSphere: CclusterToLegacyVariablesMapVsphere,
	InfrastructureProviderAWS:     CclusterToLegacyVariablesMapAws,
	InfrastructureProviderAzure:   CclusterToLegacyVariablesMapAzure,
	InfrastructureProviderDocker:  CclusterToLegacyVariablesMapDocker,
}

func init() {
	for key, value := range CclusterToLegacyVariablesMapCommon {
		CclusterToLegacyVariablesMapAws[key] = value
		CclusterToLegacyVariablesMapAzure[key] = value
		CclusterToLegacyVariablesMapVsphere[key] = value
		CclusterToLegacyVariablesMapDocker[key] = value
	}
}
