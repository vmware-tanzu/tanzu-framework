...
type Client struct {
	...
	DescribeClusterStub        func(client.DescribeTKGClustersOptions) (*tree.ObjectTree, *v1alpha4.Cluster, *v1alpha3.ProviderList, error)
	...
	GetMachineDeploymentsStub        func(client.GetMachineDeploymentOptions) ([]v1alpha4.MachineDeployment, error)
	...
	getMachineDeploymentsReturns struct {
		result1 []v1alpha4.MachineDeployment
		result2 error
	}
...
func (fake *Client) DescribeCluster(arg1 client.DescribeTKGClustersOptions) (*tree.ObjectTree, *v1alpha4.Cluster, *v1alpha3.ProviderList, error) {
...
func (fake *Client) DescribeClusterCalls(stub func(client.DescribeTKGClustersOptions) (*tree.ObjectTree, *v1alpha4.Cluster, *v1alpha3.ProviderList, error)) {
	fake.describeClusterMutex.Lock()
...
func (fake *Client) DescribeClusterReturns(result1 *tree.ObjectTree, result2 *v1alpha4.Cluster, result3 *v1alpha3.ProviderList, result4 error) {
	fake.describeClusterMutex.Lock()
	defer fake.describeClusterMutex.Unlock()
...
func (fake *Client) DescribeClusterReturnsOnCall(i int, result1 *tree.ObjectTree, result2 *v1alpha4.Cluster, result3 *v1alpha3.ProviderList, result4 error) {
	fake.describeClusterMutex.Lock()
	defer fake.describeClusterMutex.Unlock()
	fake.DescribeClusterStub = nil
...
func (fake *Client) GetMachineDeployments(arg1 client.GetMachineDeploymentOptions) ([]v1alpha4.MachineDeployment, error) {
...
func (fake *Client) GetMachineDeploymentsCalls(stub func(client.GetMachineDeploymentOptions) ([]v1alpha4.MachineDeployment, error)) {
	fake.getMachineDeploymentsMutex.Lock()
...
func (fake *Client) GetMachineDeploymentsReturns(result1 []v1alpha4.MachineDeployment, result2 error) {
	fake.getMachineDeploymentsMutex.Lock()
	defer fake.getMachineDeploymentsMutex.Unlock()
...
func (fake *Client) GetMachineDeploymentsReturnsOnCall(i int, result1 []v1alpha4.MachineDeployment, result2 error) {
	fake.getMachineDeploymentsMutex.Lock()
	defer fake.getMachineDeploymentsMutex.Unlock()
	fake.GetMachineDeploymentsStub = nil
