...
var (
	...
	defaultWebhookServiceNamespace      = "tkg-system"
	defaultWebhookServiceName           = "tanzu-featuregates-webhook-service"
	defaultWebhookSecretNamespace       = "tkg-system"
...
func main() {
	...
	signalHanlder := ctrl.SetupSignalHandler()
	...
	// Start cert manager.
	if err := certManager.Start(signalHanlder); err != nil {
	...
	if err := mgr.Start(signalHanlder); err != nil {
