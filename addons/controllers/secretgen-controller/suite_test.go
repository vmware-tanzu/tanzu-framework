...
func TestAddonController(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t,
		"SecretGenControllerConfig Controller Suite",
...
var _ = BeforeSuite(func(done Done) {
	...
	setupLog := ctrl.Log.WithName("controllers").WithName("SecretGenControllerConfig")

	ctx, cancel = context.WithCancel(ctx)

	Expect((&SecretGenControllerConfigReconciler{
