...
var _ = Describe("Calico Ytt Templates", func() {
	var (
		...
		templatesDir          = filepath.Join(repo.RootDir(), "addons/calico/templates")
		fileCalicoYaml        = filepath.Join(templatesDir, "base-files/calico.yaml")
		fileCalicoOverlayYaml = filepath.Join(templatesDir, "overlays/calico_overlay.yaml")
		fileValuesYaml        = filepath.Join(templatesDir, "values.yaml")
		fileValuesStar        = filepath.Join(templatesDir, "values.star")
	)
