...
```
2. Decide how to plumb data values to the package if any.
```mermaid
flowchart TD
    ...
    B ---->|No| Z[No values]
```
3. If using a provider create an API + Controller. It is not necessary that the API and controller live in tanzu-framework.
