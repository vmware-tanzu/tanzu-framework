...
require (
	...
	github.com/vmware-tanzu-private/tkg-cli v1.3.0-pre-rc.1.0.20210209065338-fc46a6ec5bf4
	github.com/vmware-tanzu-private/tkg-providers v1.3.0-pre-alpha-1.0.20210209065342-8b3559d2ed49 // indirect
