...
require (
	...
	github.com/vmware-tanzu-private/tkg-cli v1.3.0-rc.1.0.20210218234128-1908f3392a31
	github.com/vmware-tanzu-private/tkg-providers v1.3.0-rc.1.0.20210218234139-faffa228a247 // indirect
