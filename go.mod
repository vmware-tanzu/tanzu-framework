...
require (
	...
	github.com/vmware-tanzu-private/tkg-cli v1.3.0-pre-alpha-1.0.20210208180149-9cabc4346c18
	github.com/vmware-tanzu-private/tkg-providers v1.3.0-pre-alpha-1.0.20210206042800-16c0de8aa0d5 // indirect
